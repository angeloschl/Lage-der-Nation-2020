...
LDN_Kapitel %>%   
  ...
  geom_col(fill = Farbe_LND_1)+
  scale_y_time(breaks=c(0,3600,7200,10800,14400,18000,21600,25200,28800,32400,36000,39600,43200,46800,50400,54000),
               labels=c("0","1:00","2:00","3:00","4:00","5:00","6:00","7:00","8:00","9:00","10:00","11:00","12:00","13:00","14:00","15:00"),
               limits = c(0,57000), 
               expand = c(0,NA))+
  coord_flip()+
