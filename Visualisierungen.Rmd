...
# Allgemeines
Für die Auswertung wurde der öffentliche RRS-Feed der Lage der Nation genutzt.
In dieser Auswertung wurde sich nur auf das Jahr 2020 konzentriert. 
...
# Top 10 Kapitel in 2020 - Häufigkeit

Da die Kapitel oft unterschiedliche genannt wurden, aber die Inhalte gleich sind, wurden sie manuell zusammengefasst. Hier das Beispiel <b>"Corona"</b>: 
Covid, Corana, Corona Update, Coronavirus, Impfstoff, Impfung, Impfen, Impfpflicht, Immunitätsausweis <p>
...
LDN_Kapitel %>%
  ...
  theme(
    ...
    labs(
    title = "Top 6 Kapitel in 2020 - Pro Monat",
       subtitle = 
        paste("Die Dicke der Kriese beschreibt die Länge der Themen pro Monat"),
