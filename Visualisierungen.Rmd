...
# Abbildungen 
## Anzahl Folgen
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE,fig1, fig.height = 3, fig.width = 9}
LDN_Jahr <- LDN %>%
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE,fig.height = 3, fig.width = 9}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.width = 9}
LDN_Kapitel <- LDN %>% 
  as_tibble() %>% 
